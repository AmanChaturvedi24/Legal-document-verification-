...
while True:
    flag_ref = root_ref.child('flago/flag')
    flag_snapshot = flag_ref.get()
    if flag_snapshot and flag_snapshot == 1:
        ...
        def upload_text_to_realtime_database():
            ...
            root_ref.child('flago').set({'flag': 0})  # Replace with your desired node name
    ...
    time.sleep(5)  # Sleep for an hour before checking again
